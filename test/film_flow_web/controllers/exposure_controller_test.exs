defmodule FilmFlowWeb.ExposureControllerTest do
  ...
  @create_attrs %{frame: 42, subject: "some subject", date_exposed: ~U[2024-04-21 21:10:00Z], lighting_condition: "some lighting_condition", notes: "some notes"}
  @update_attrs %{frame: 43, subject: "some updated subject", date_exposed: ~U[2024-04-22 21:10:00Z], lighting_condition: "some updated lighting_condition", notes: "some updated notes"}
  @invalid_attrs %{frame: nil, subject: nil, date_exposed: nil, lighting_condition: nil, notes: nil}

  describe "index" do
    test "lists all exposures", %{conn: conn} do
  ...
  describe "edit exposure" do
    ...
    test "renders form for editing chosen exposure", %{conn: conn, exposure: exposure} do
  ...
  describe "update exposure" do
    ...
    test "redirects when data is valid", %{conn: conn, exposure: exposure} do
    ...
    test "renders errors when data is invalid", %{conn: conn, exposure: exposure} do
  ...
  describe "delete exposure" do
    ...
    test "deletes chosen exposure", %{conn: conn, exposure: exposure} do
